...
__attribute__((section("__versions"))) = {
	...
	{ 0x5af9eb3, __VMLINUX_SYMBOL_STR(cdev_del) },
	{ 0xb6f378de, __VMLINUX_SYMBOL_STR(cdev_add) },
	{ 0xa42dd77b, __VMLINUX_SYMBOL_STR(cdev_alloc) },
...
MODULE_INFO(srcversion, "CE5E8A140DABFA9E7B29C00");
